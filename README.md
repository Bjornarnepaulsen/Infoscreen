...
🛫 Innenriks (NRK)
🌍 Utenriks (Sky News / BBC / CNN – fallback)
...
└─ README.md
⚙️ Miljøvariabler
Alle hemmeligheter/konfig settes i .env (denne SKAL ikke committes).
.env.example (følger med repoet)
...
📰 Datastrømmer
Innenriks
Hentes fra NRK sin RSS-feed.
Utenriks (fallback-mekanisme)
Sky News World
BBC World
CNN World
Den første tilgjengelige brukes.
...
“Utenriks”
Rotasjon
Seksjon skifter automatisk hvert 15. sekund
